    ...
    <Template>
      <main className="min-h-screen px-28 py-28 bg-[#FFF6F6] flex flex-col align-middle space-y-20">
        ...
        <div className="flex flex-row align-middle justify-evenly">
          <div className="bg-white rounded-xl px-5 py-10 space-y-5 flex flex-col align-middle justify-evenly shadow-xl w-1/5">
            <span className="text-center font-bold text-xl text-[#F875AA]">Data Kelas Yang Tersedia</span>
