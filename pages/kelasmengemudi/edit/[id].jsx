...
const Edit = () => {
  ...
  const [kelasMengemudiID, setKelasMengemudiID] = useState()
  ...
  const [calonPelanggan, setCalonPelanggan] = useState("")
  ...
  useEffect(() => {
    ...
    fetch("https://rpl-backend-production.up.railway.app/v1/kelasmengemudi/list/" + router.query.id, {
      ...
      setKelasMengemudiID(responsejson.data.kelasMengemudiID)
      ...
      setKendaraan(responsejson.data.kendaraan)
      setCalonPelanggan(responsejson.data.calonPelanggan)
    })
  }, [])
  return <>
    <Template>
      <main className="min-h-screen px-14 py-5 bg-[#FFF6F6]">
        ...
        <form className="w-2/3 mx-auto space-y-10 flex flex-col align-middle justify-evenly" onSubmit={(e) => {
          ...
          <div className="flex flex-row align-middle justify-between">
            <span className="h-min my-auto font-bold text-lg">ID Kelas Mengemudi</span>
            <span className="h-min my-auto font-bold text-lg">{kelasMengemudiID}</span>
          </div>
          <div className="flex flex-row align-middle justify-between">
          ...
          <div className="flex flex-row align-middle justify-between">
            <span className="h-min my-auto font-bold text-lg">Calon Pelanggan ID</span>
            <input value={calonPelanggan} onChange={(e) => {
              setCalonPelanggan(e.target.value)
            }} type="tel" required className="drop-shadow-xl w-2/3 p-2 rounded-xl" />
          </div>
